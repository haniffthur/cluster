...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        ...
        <form action="{{ route('cards.index') }}" method="GET" class="form-inline mb-3">
            <input type="text" name="search" class="form-control mr-2" placeholder="Cari No Kartu / Pemilik..." value="{{ request('search') }}">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            @else
                                <span class="badge badge-secondary">Tamu / Staff</span>
                            @endif
                        </td>
                        <td>
                            @if($card->resident)
                        ...
                        <td>
                            ...
                            <form action="{{ route('cards.destroy', $card->id) }}" method="POST" class="d-inline" onsubmit="return confirm('Hapus kartu ini?');">
                                @csrf
                                @method('DELETE')
